...
const controlRecipes = async function() {
    try {
        ...
        if (!id) return;
        // Spinner
        (0, _recipeViewDefault.default).spinnerLoading();
...
const controlSearchResults = async function() {
    try {
        (0, _resultsViewDefault.default).spinnerLoading();
        // 1.) Get search query
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        (0, _addRecipeViewDefault.default).spinnerLoading();
...
},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"Y4A21","./config.js":"k5Hzs","./views/RecipeView":"aFEMw","./views/searchView":"9OQAM","./views/resultsView":"cSbZE","./views/bookmarksView":"4Lqzq","./views/addRecipeView":"i6DNj","regenerator-runtime/runtime":"dXNgZ","./views/paginationView":"6z7bi","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((ing)=>ing[0].startsWith("ingredient") && ing[1] !== "").map((ing)=>{
            ...
            if (ingArr.length !== 3) throw new Error("Wrong Ingredient format! Please use the corrrect format :)");
...
const KEY = "984a5e6b-da1a-471e-a70b-d523410cb3a2";
...
},{"regenerator-runtime":"dXNgZ","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aFEMw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
